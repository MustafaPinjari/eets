  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        muted: {
          DEFAULT: "var(--color-muted)", /* primary-5 */
          foreground: "var(--color-muted-foreground)", /* blue-gray-500 */
        },
        accent: {
        ...
        success: {
          DEFAULT: "var(--color-success)", /* deeper-sage */
          foreground: "var(--color-success-foreground)", /* white */
        },
        warning: {
          DEFAULT: "var(--color-warning)", /* earthy-amber */
      ...
      boxShadow: {
        soft: '0 1px 3px rgba(61, 64, 91, 0.1)',
        elevated: '0 4px 12px rgba(61, 64, 91, 0.15)',
      },
      transitionDuration: {
        '150': '150ms',
        '250': '250ms',
